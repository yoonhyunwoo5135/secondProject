...
<!------------------------------------------------------------------------------------------------------------------------------------------------------------->
	<div id="board" style="position: absolute; left: 475px; width: 900px; height: 800px;">
        ...
        <tr>
            <td>제목</td>
           <td><input type="text" id="temp" style="left:92px; height:27px; width:650px; margin-top: -5px;"></td>
        </tr>
        <tr>
            <td>내용</td>
            <td>
               <textarea rows="10" cols="30" id="content" name="content" style="width:650px; height:350px; margin-top: 50px; "></textarea>
            </td>
        </tr>
</table>
